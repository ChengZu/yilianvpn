...
public:
	...
	//单个客户端TCP代理最大值
	static const int CLIENT_MAX_TCPPROXY= 256;
	//单个客户端UDP代理最大值
	static const int CLIENT_MAX_UDPPROXY= 256;
	//客户端过期时间秒 
	static const long CLIENT_EXPIRE_TIME= 60 * 3;
	//TCP代理过期时间秒 
	static const long TCPPROXY_EXPIRE_TIME= 60 * 60;
	//UDP代理过期时间秒 
	static const long UDPPROXY_EXPIRE_TIME= 60 * 5;
	//TCP连接超时时间秒 
