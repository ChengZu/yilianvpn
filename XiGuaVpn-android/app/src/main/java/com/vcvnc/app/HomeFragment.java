...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        stopRunBtn.setOnClickListener(view -> {
            if(isRunning && !onStop){
                onStop = true;
                closeVpn();
                updateUI();
    ...
    private void updateUI() {
        if(onStart){
            ...
            startRunBtn.setVisibility(View.INVISIBLE);
            stopRunBtn.setVisibility(View.VISIBLE);
            infoMsg.setText(format("%s%s:%d", getString(R.string.connected), ProxyConfig.serverIp, ProxyConfig.serverPort));
        }else if(!VpnServiceHelper.vpnRunningStatus()){
            startRunBtn.setVisibility(View.VISIBLE);
            stopRunBtn.setVisibility(View.INVISIBLE);
            infoMsg.setText(format("%s%s:%d", getString(R.string.not_connect), ProxyConfig.serverIp, ProxyConfig.serverPort));
        }
        String msg = "";
