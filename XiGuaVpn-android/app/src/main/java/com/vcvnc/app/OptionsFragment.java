...
public class OptionsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Button saveBtn = root.findViewById(R.id.options_save_btn);
    ...
    public void setUIPort(int value) {
        this.port.setText(String.valueOf(value));
    }
    ...
    public void setUIUserName(int value) {
        this.userName.setText(String.valueOf(value));
    }
    ...
    public void setUIUserPwd(int value) {
        this.userPwd.setText(String.valueOf(value));
    }
